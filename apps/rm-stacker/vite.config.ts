...
export default defineConfig(({ command }) => ({
  ...
  // page that asked for it: `/rm-stacker/profile` and `/rm-stacker/` sit at
  // different depths and a relative address would resolve differently on each.
