...
Drawn from the imports under `src` at 8da496e by `pnpm architecture`.
...
graph TD
  ...
  places["places<br/>49 files · 25233 lines"]
...
| `places`       | a published place: its script, its people, and the sandbox they run in | 49    | 25233 |
