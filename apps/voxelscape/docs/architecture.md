...
Drawn from the imports under `src` at e025c6a by `pnpm architecture`.
...
graph TD
  ...
  places["places<br/>40 files · 20229 lines"]
...
| `places`       | a published place: its script, its people, and the sandbox they run in | 40    | 20229 |
