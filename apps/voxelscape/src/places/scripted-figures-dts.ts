// The ambient declaration typing the "scripted-figures" standard library
// (scripted-figures-lib.ts) for the panel's language service. Fixed and
// static — unlike a model's generated `.d.ts`, this one names no place data,
// so it is the same for every project and never needs regenerating.
export const SCRIPTED_FIGURES_DTS = `declare module "scripted-figures" {
